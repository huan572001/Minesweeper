...
class Game():
    ...
    def drawmenu(self):
        ...
        pygame.draw.rect(DISPLAYSURF, GREEN, (200, 200, 200, 50))  # Hình chữ nhật
        self.textSet('9x9', 250, 200)
        pygame.draw.rect(DISPLAYSURF, RED, (200, 300, 200, 50))  # Hình chữ nhật
        self.textSet('9x9', 250, 300)
        pygame.draw.rect(DISPLAYSURF, BLUE, (200, 400, 200, 50))  # Hình chữ nhật
        self.textSet('9x9', 250, 400)
